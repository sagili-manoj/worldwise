/* 
    Used Locala Stroage beacuse running (local json server)npm i server in netlify as well as in vercel is not supported 
    At the end I have written a full code on how to implement this application using is a json file .
*/
import {
  createContext,
  useEffect,
...
/*   
Implementation using local server
